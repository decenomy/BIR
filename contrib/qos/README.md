...
This means one can have an always-on pivxd instance running, and another local pivxd/birakecoin-qt instance which connects to this node and receives blocks from it.
