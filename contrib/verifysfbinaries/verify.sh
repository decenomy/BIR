...
###   This script attempts to download the signature file SHA256SUMS.asc from birakecoinn.org
...
WORKINGDIR="/tmp/birakecoinn"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://birakecoinn.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://birakecoinn.org/bin/"
VERSIONPREFIX="birakecoinn-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'birakecoinn-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[birakecoinn-]<version>-[rc[0-9]] (example: birakecoinn-0.9.2-rc1)"
   echo "wget output:"
