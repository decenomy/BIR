...
In order to support loading of multiple wallets in birakecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is birakecoin.cpp.
...
Changes to birakecoin.cpp
----------------------
birakecoin.cpp is the entry point into birakecoin-qt, and as such, will require some minor modifications to provide hooks for
