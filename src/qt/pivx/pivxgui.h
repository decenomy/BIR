...
#ifndef BirakeCoin_CORE_NEW_GUI_PIVXGUI_H
#define BirakeCoin_CORE_NEW_GUI_PIVXGUI_H
...
/**
  birakecoin GUI main class. This class represents the main window of the BirakeCoin UI. It communicates with both the client and
...
#endif //BirakeCoin_CORE_NEW_GUI_PIVXGUI_H
