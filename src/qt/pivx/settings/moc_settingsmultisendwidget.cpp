...
QT_INIT_METAOBJECT const QMetaObject MultiSendModel::staticMetaObject = { {
    &QAbstractTableModel::staticMetaObject,
    qt_meta_stringdata_MultiSendModel.data,
    qt_meta_data_MultiSendModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void SettingsMultisendWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SettingsMultisendWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SettingsMultisendWidget::staticMetaObject = { {
    &PWidget::staticMetaObject,
    qt_meta_stringdata_SettingsMultisendWidget.data,
    qt_meta_data_SettingsMultisendWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
