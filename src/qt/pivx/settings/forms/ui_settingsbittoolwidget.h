...
public:
    ...
    {
        SettingsBitToolWidget->setWindowTitle(QCoreApplication::translate("SettingsBitToolWidget", "Form", nullptr));
        labelTitle->setText(QCoreApplication::translate("SettingsBitToolWidget", "BIP38 Tool", nullptr));
        labelSubtitle1->setText(QCoreApplication::translate("SettingsBitToolWidget", "Encrypt your BIR addresses (key pair actually) using BIP38 encryption.\n"
"Using this mechanism you can share your keys without middle-man risk, only need to store your passphrase safely", nullptr));
        ...
        labelSubtitleAddress->setText(QCoreApplication::translate("SettingsBitToolWidget", "BIR address", nullptr));
