...
"BIR Core Wallet", nullptr));
        labelMessage2->setText(QCoreApplication::translate("WelcomeContentWidget", "BIR is the world\342\200\231s most innovative Proof of Stake blockchain based technology. Developed by a team of highly experienced developers and cryptographers.", nullptr));
        labelTitle3->setText(QCoreApplication::translate("WelcomeContentWidget", "How BIR respects your privacy?", nullptr));
        labelMessage3->setText(QCoreApplication::translate("WelcomeContentWidget", "<html><head/><body><p>As our manifesto says: Privacy is a non-negotiable basic human right; it grants users the freedom to share their data whenever and with whomever they want - BIR believes in self sovereignty.</p></body></html>", nullptr));
        labelTitle4->setText(QCoreApplication::translate("WelcomeContentWidget", "What is a Masternode?", nullptr));
        labelMessage4->setText(QCoreApplication::translate("WelcomeContentWidget", "The masternode network is BIR's second layer network on top of the blockchain that enables our DAO to provide decentralized governance and a treasury.", nullptr));
    } // retranslateUi
