                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BirakeCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BirakeCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and birakecoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BirakeCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about BirakeCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BirakeCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BirakeCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BirakeCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a BirakeCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BirakeCoin Core help message to get a list with possible BirakeCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BirakeCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BirakeCoin network", "", count));
}
...
{
    QString strTitle = tr("BirakeCoin Core"); // default title
