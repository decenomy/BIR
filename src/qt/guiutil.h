...
/** Utility functions used by the BirakeCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render BirakeCoin addresses in monospace font
...
// Parse "bir:" URI into recipient object, return true on successful parsing
