...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BirakeCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "BirakeCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BirakeCoin features */
        {"birakecoin", "masternode", &masternode, true, true, false},
        {"birakecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"birakecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"birakecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"birakecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"birakecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"birakecoin", "startmasternode", &startmasternode, true, true, false},
        {"birakecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"birakecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"birakecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"birakecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"birakecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"birakecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"birakecoin", "mnbudget", &mnbudget, true, true, false},
        {"birakecoin", "preparebudget", &preparebudget, true, true, false},
        {"birakecoin", "submitbudget", &submitbudget, true, true, false},
        {"birakecoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"birakecoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"birakecoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"birakecoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"birakecoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"birakecoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"birakecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"birakecoin", "checkbudgets", &checkbudgets, true, true, false},
        {"birakecoin", "mnsync", &mnsync, true, true, false},
        {"birakecoin", "spork", &spork, true, true, false},
        {"birakecoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"birakecoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use birakecoind, or the -server option to birakecoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> birakecoin-cli " + methodname + " " + args + "\n";
}
