/* src/config/birakecoin-config.h.  Generated from birakecoin-config.h.in by configure.  */
/* src/config/birakecoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.birake.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BirakeCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BirakeCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "birakecoin"
