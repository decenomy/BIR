...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BirakeCoin Core birakecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  birakecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded birakecoin transaction") + "\n" +
                               "  birakecoin-tx [options] -create [commands]   " + _("Create hex-encoded birakecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded birakecoin transaction
